...
class View extends Node {
  ...
  static fromCube (cube) {
    ...
    const cubeSource = cube.source.constructor.fromSource ? cube.source.constructor.fromSource(cube.source, cube) : getCubeSource(cube)
  ...
  async fetchViewFull () {
    const query = this.viewFullQuery()

...
filter.eq = (predicate, value) => filter.operation(predicate, value, ns.view.Eq)
filter.ne = (predicate, value) => filter.operation(predicate, value, ns.view.Ne)
filter.lt = (predicate, value) => filter.operation(predicate, value, ns.view.Lt)
filter.gt = (predicate, value) => filter.operation(predicate, value, ns.view.Gt)
filter.lte = (predicate, value) => filter.operation(predicate, value, ns.view.Lte)
filter.gte = (predicate, value) => filter.operation(predicate, value, ns.view.Gte)
filter.in = (predicate, values) => filter.operation(predicate, values, ns.view.In)

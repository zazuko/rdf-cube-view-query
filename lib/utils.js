...
export function findDataset(objects) {
...
export function findParent(objects) {
  if ([...objects].length === 0) {
    return undefined
  }
...
export function objectSetterGetter(obj, property, value, { map = v => v, ptr = obj.ptr } = {}) {

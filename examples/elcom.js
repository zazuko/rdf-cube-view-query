...
async function main() {
  ...
  const periodMin = parseInt(periodDimension.cubeDimensions[0].minInclusive.value)
  const periodMax = parseInt(periodDimension.cubeDimensions[0].maxInclusive.value)
  ...
  const municipalityFilter = municipalityDimension.filter.in(municipalities.slice(0, 2))
